...
unsigned long IBE_Verify_Key(const ZZX SK_id[3], const vec_ZZ id, const MSK_Data * const MSKD, const MPK_Data * const MPKD);
void IBE_Encrypt(long C[3][N0], const long m[N0], const long id0[N0], const MPK_Data * const MPKD);
